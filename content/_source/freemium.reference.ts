 ...
 *
 * Every content item (guidebook chapter, toolkit tool, diary week) carries a
 * `chapter` number. Diary weeks map to chapters via chapterForWeek().
 */
...
/**
 * Paywall copy (bilingual). Keep it honest — no fake urgency, no countdowns,
 * no inflated anchor prices. State plainly that proceeds fund free programs.
 */
export const paywallCopy = {
  en: {
    title: "Unlock the full journey",
    body:
      "Chapters 1–4 are yours for free. Unlock all 12 chapters — the complete guidebook, all 12 tools, and the full 52-week diary — with a single one-time purchase.",
  ...
  id: {
    ...
    body:
      "Bab 1–4 gratis untuk Anda. Buka seluruh 12 bab — panduan lengkap, 12 alat, dan diari penuh 52 minggu — dengan satu kali pembelian.",
    cta: "Buka semuanya",
